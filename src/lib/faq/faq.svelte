<script lang="ts">
	import Accordion from '$lib/core/components/accordion.svelte';
...
<div class="relative flex min-h-screen items-center justify-center p-4 sm:p-6 lg:p-8">
	...
	<div class="mx-auto w-full max-w-7xl text-white">
		<h2 class="mb-8 text-center text-2xl font-bold text-white md:mb-12">You asked, we answered</h2>
		<Accordion items={faqData} className="" iconClassName="text-base-300" />
	</div>
</div>
